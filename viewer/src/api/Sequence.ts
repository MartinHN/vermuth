...
export class Sequence {
  ...
  resolveState(stateResolver: (n:string)=>State|undefined){
...
export class SequencePlayer{
  ...
  goTo(nSeq:Sequence,fl:DirectFixture[],stateResolver:(n:string)=>State|undefined,sendValueCB:(f:ChannelBase,v:number) => void,cb:() => void):void{
    this.nextSeq = nSeq;
    const res = 10
